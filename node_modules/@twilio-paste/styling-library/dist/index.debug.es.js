...
var EmotionCacheContext = createContext(typeof HTMLElement !== "undefined" ? cache_esm_default() : null);
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, context, ref) {
      return createElement2(ThemeContext.Consumer, null, function(theme) {
        ...
        var ele = createElement2(finalTag, newProps);
        if (!isBrowser4 && rules !== void 0) {
          ...
          return createElement2(Fragment2, null, createElement2("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
            __html: rules
          }, _ref.nonce = context.sheet.nonce, _ref)), ele);
        }
        return ele;
...
import React__default, {createElement as createElement3, forwardRef as forwardRef2} from "react";
...
var ThemeProvider = function ThemeProvider2(props) {
  return createElement3(ThemeContext.Consumer, null, function(theme) {
    if (props.theme !== theme) {
      theme = createCacheWithTheme(theme)(props.theme);
    }
    return createElement3(ThemeContext.Provider, {
      value: theme
    }, props.children);
  });
};
function withTheme(Component2) {
  ...
  var render = function render2(props, ref) {
    return createElement3(ThemeContext.Consumer, null, function(theme) {
      return createElement3(Component2, import_extends.default({
        theme,
        ref
      }, props));
    });
  };
  var WithTheme = forwardRef2(render);
