...
var require_inheritsLoose = __commonJS((exports2, module2) => {
...
var EmotionCacheContext = import_react.createContext(typeof HTMLElement !== "undefined" ? cache_esm_default() : null);
...
var withEmotionCache = function withEmotionCache2(func) {
  ...
  return import_react.forwardRef(render);
};
if (!isBrowser3) {
  BasicProvider = /* @__PURE__ */ function(_React$Component) {
    import_inheritsLoose.default(BasicProvider2, _React$Component);
    ...
    _proto.render = function render() {
      return import_react.createElement(EmotionCacheContext.Provider, this.state, this.props.children(this.state.value));
    };
    return BasicProvider2;
  }(import_react.Component);
  withEmotionCache = function withEmotionCache3(func) {
    return function(props) {
      return import_react.createElement(EmotionCacheContext.Consumer, null, function(context) {
        if (context === null) {
          return import_react.createElement(BasicProvider, null, function(newContext) {
...
var Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
  ...
  if (typeof styles === "function") {
    return import_react.createElement(ThemeContext.Consumer, null, function(theme) {
      ...
      return import_react.createElement(InnerGlobal, {
...
var InnerGlobal = /* @__PURE__ */ function(_React$Component) {
  import_inheritsLoose.default(InnerGlobal2, _React$Component);
  ...
  _proto.render = function render() {
    if (!isBrowser3) {
      ...
      if (!shouldCache) {
        var _ref;
        return import_react.createElement("style", (_ref = {}, _ref["data-emotion-" + this.props.cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
...
var ClassNames = withEmotionCache(function(props, context) {
  return import_react.createElement(ThemeContext.Consumer, null, function(theme) {
    ...
    if (!isBrowser3 && rules.length !== 0) {
      var _ref;
      return import_react.createElement(import_react.Fragment, null, import_react.createElement("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
        __html: rules
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, context, ref) {
      return import_react2.createElement(ThemeContext.Consumer, null, function(theme) {
        ...
        var ele = import_react2.createElement(finalTag, newProps);
        if (!isBrowser4 && rules !== void 0) {
          ...
          return import_react2.createElement(import_react2.Fragment, null, import_react2.createElement("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
            __html: rules
          }, _ref.nonce = context.sheet.nonce, _ref)), ele);
        }
        return ele;
...
var ThemeProvider = function ThemeProvider2(props) {
  return import_react3.createElement(ThemeContext.Consumer, null, function(theme) {
    if (props.theme !== theme) {
      theme = createCacheWithTheme(theme)(props.theme);
    }
    return import_react3.createElement(ThemeContext.Provider, {
      value: theme
    }, props.children);
  });
};
function withTheme(Component2) {
  ...
  var render = function render2(props, ref) {
    return import_react3.createElement(ThemeContext.Consumer, null, function(theme) {
      return import_react3.createElement(Component2, import_extends.default({
        theme,
        ref
      }, props));
    });
  };
  var WithTheme = import_react3.forwardRef(render);
  WithTheme.displayName = "WithTheme(" + componentName + ")";
  return import_hoist_non_react_statics.default(WithTheme, Component2);
}
...
var transforms = [
  ...
  "left",
  "right"
].reduce((acc, curr) => __assign(__assign({}, acc), {
...
var css2 = (args) => (props = {}) => {
  const theme = __assign(__assign({}, defaultTheme), props.theme || props);
  let result = {};
  ...
  for (const key in styles) {
    ...
    if (key === "variant") {
      ...
      result = __assign(__assign({}, result), variant3);
      continue;
    }
...
var merge2 = function merge3(a, b) {
  var result = import_object_assign.default({}, a, b);
  for (var key in a) {
    var _assign;
    if (!a[key] || typeof b[key] !== "object")
      continue;
    import_object_assign.default(result, (_assign = {}, _assign[key] = import_object_assign.default(a[key], b[key]), _assign));
  }
  return result;
};
  ...
  var parse = function parse2(props) {
    ...
    for (var key in props) {
      ...
      if (typeof raw === "object") {
        cache.breakpoints = !isCacheDisabled && cache.breakpoints || get2(props.theme, "breakpoints", defaults.breakpoints);
        if (Array.isArray(raw)) {
          cache.media = !isCacheDisabled && cache.media || [null].concat(cache.breakpoints.map(createMediaQuery));
          styles = merge2(styles, parseResponsiveStyle(cache.media, sx, scale, raw, props));
          continue;
        }
        if (raw !== null) {
          styles = merge2(styles, parseResponsiveObject(cache.breakpoints, sx, scale, raw, props));
          shouldSort = true;
        }
        continue;
      }
      import_object_assign.default(styles, sx(raw, scale, props));
    }
    if (shouldSort) {
      styles = sort(styles);
    }
...
var parseResponsiveStyle = function parseResponsiveStyle2(mediaQueries, sx, scale, raw, _props) {
  ...
  raw.slice(0, mediaQueries.length).forEach(function(value, i) {
    ...
    if (!media) {
      import_object_assign.default(styles, style3);
    } else {
      var _assign2;
      import_object_assign.default(styles, (_assign2 = {}, _assign2[media] = import_object_assign.default({}, styles[media], style3), _assign2));
    }
  });
  return styles;
};
var parseResponsiveObject = function parseResponsiveObject2(breakpoints, sx, scale, raw, _props) {
  ...
  for (var key in raw) {
    ...
    if (!breakpoint) {
      ...
      import_object_assign.default(styles, (_assign3 = {}, _assign3[media] = import_object_assign.default({}, styles[media], style3), _assign3));
    }
  }
  return styles;
};
...
var compose = function compose2() {
  ...
  parsers.forEach(function(parser2) {
    if (!parser2 || !parser2.config)
      return;
    import_object_assign.default(config9, parser2.config);
  });
  var parser = createParser(config9);
  return parser;
};
...
var themeGet = function themeGet2(path, fallback) {
  ...
  return function(props) {
    return get2(props.theme, path, fallback);
  };
};
...
var css3 = function css4(args) {
  return function(props) {
    ...
    var theme = _extends2({}, defaultTheme2, {}, props.theme || props);
    var result = {};
...
var variant = function variant2(_ref) {
  ...
  if (Object.keys(variants).length) {
    sx = function sx2(value, scale2, props) {
      return index_esm_default10(get2(scale2, value, null))(props.theme);
    };
  } else {
