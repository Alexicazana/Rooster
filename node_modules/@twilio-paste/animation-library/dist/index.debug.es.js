...
var useLayoutEffect = typeof window !== "undefined" && window.document && window.document.createElement ? useLayoutEffect$1 : useEffect;

// ../../../node_modules/@react-spring/core/index.js
import {useContext, createElement as createElement2, createContext, useMemo, useRef as useRef3, useState as useState2, Fragment} from "react";

// ../../../node_modules/@react-spring/animated/index.js
import {forwardRef, useRef as useRef2, useCallback, useEffect as useEffect2, createElement} from "react";
...
var withAnimated = (Component, host2) => {
  ...
  return forwardRef((givenProps, givenRef) => {
    ...
    return /* @__PURE__ */ createElement(Component, __assign(__assign({}, usedProps), {
      ref
    }));
  });
};
...
var SpringContext = (_a) => {
  ...
  const {Provider} = ctx;
  return /* @__PURE__ */ createElement2(Provider, {
    value: props
  }, children);
};
...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => /* @__PURE__ */ createElement2(Fragment, null, transitions.map((t, i) => {
    const {springs} = changes.get(t) || t.ctrl;
    const elem = render(__assign({}, springs), t.item, t, i);
    return elem && elem.type ? /* @__PURE__ */ createElement2(elem.type, __assign(__assign({}, elem.props), {
...
function useReducedMotion() {
  const [prefersReducedMotion, setPrefersReducedMotion] = useState3(getMediaQueryList().matches);
  useEffect3(() => {
