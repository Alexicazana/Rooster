...
var AnimatedSkeleton = import_animation_library.animated(import_box.Box);
var StyledAnimatedSkeleton = import_styling_library.styled(AnimatedSkeleton)(() => import_styling_library.css({
...
var SkeletonLoader = React.forwardRef((_a, ref) => {
  var {
  ...
  const animatedSkeletonStyles = import_animation_library.useSpring(animatedConfig);
  return /* @__PURE__ */ React.createElement(import_box.Box, __assign(__assign({}, import_box.safelySpreadBoxProps(props)), {
    ...
    width,
    ref
  }), /* @__PURE__ */ React.createElement(StyledAnimatedSkeleton, {
    bottom: 0,
    left: 0,
    position: "absolute",
    right: 0,
