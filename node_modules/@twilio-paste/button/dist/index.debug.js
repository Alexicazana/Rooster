...
var import_box13 = __toModule(require("@twilio-paste/box"));
var import_spinner = __toModule(require("@twilio-paste/spinner"));
...
var import_ArrowForwardIcon = __toModule(require("@twilio-paste/icons/cjs/ArrowForwardIcon"));
...
var DirectButtonPropTypes = {
  ...
  size: PropTypes.oneOf(["small", "default", "icon", "icon_small", "reset"]).isRequired,
...
var ButtonPropTypes = {
  ...
  fullWidth: PropTypes.bool,
  href: PropTypes.string,
  size: PropTypes.oneOf(["small", "default", "icon", "icon_small", "reset"]),
  tabIndex: PropTypes.oneOf([0, -1]),
  type: PropTypes.oneOf(["submit", "button", "reset"]),
  disabled: PropTypes.bool,
...
var PrimaryButton = React.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React.createElement(import_box.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box.safelySpreadBoxProps(props)), ButtonStyleMapping[buttonState]), SizeStyles[size]));
});
...
var PrimaryIconButton = React2.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React2.createElement(import_box2.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box2.safelySpreadBoxProps(props)), ButtonStyleMapping2[buttonState]), SizeStyles[size]));
});
...
var SecondaryButton = React3.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React3.createElement(import_box3.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box3.safelySpreadBoxProps(props)), ButtonStyleMapping3[buttonState]), SizeStyles[size]));
});
...
var SecondaryIconButton = React4.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React4.createElement(import_box4.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box4.safelySpreadBoxProps(props)), ButtonStyleMapping4[buttonState]), SizeStyles[size]));
});
...
var DestructiveButton = React5.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React5.createElement(import_box5.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box5.safelySpreadBoxProps(props)), ButtonStyleMapping5[buttonState]), SizeStyles[size]));
});
...
var DestructiveIconButton = React6.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React6.createElement(import_box6.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box6.safelySpreadBoxProps(props)), ButtonStyleMapping6[buttonState]), SizeStyles[size]));
});
...
var DestructiveLinkButton = React7.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React7.createElement(import_box7.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box7.safelySpreadBoxProps(props)), ButtonStyleMapping7[buttonState]), SizeStyles[size]));
});
...
var import_box8 = __toModule(require("@twilio-paste/box"));
...
var DestructiveSecondaryButton = React8.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React8.createElement(import_box8.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box8.safelySpreadBoxProps(props)), ButtonStyleMapping8[buttonState]), SizeStyles[size]));
});
...
var import_box9 = __toModule(require("@twilio-paste/box"));
...
var LinkButton = React9.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React9.createElement(import_box9.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box9.safelySpreadBoxProps(props)), ButtonStyleMapping9[buttonState]), SizeStyles[size]));
});
...
var import_box10 = __toModule(require("@twilio-paste/box"));
...
var InverseButton = React10.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React10.createElement(import_box10.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box10.safelySpreadBoxProps(props)), ButtonStyleMapping10[buttonState]), SizeStyles[size]));
});
...
var import_box11 = __toModule(require("@twilio-paste/box"));
...
var InverseLinkButton = React11.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React11.createElement(import_box11.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box11.safelySpreadBoxProps(props)), ButtonStyleMapping11[buttonState]), SizeStyles[size]));
});
...
var import_box12 = __toModule(require("@twilio-paste/box"));
...
var ResetButton = React12.forwardRef((_a, ref) => {
  var {size, buttonState, fullWidth} = _a, props = __rest(_a, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React12.createElement(import_box12.Box, __assign(__assign(__assign({
    ref,
    width: fullWidth ? "100%" : "auto"
  }, import_box12.safelySpreadBoxProps(props)), ButtonStyleMapping12[buttonState]), SizeStyles[size]));
});
...
// src/index.tsx
var AnimatedBox = import_animation_library.animated(import_box13.Box);
...
var ButtonContents = ({buttonState, children, showLoading, variant}) => {
  ...
  return /* @__PURE__ */ React13.createElement(React13.Fragment, null, /* @__PURE__ */ React13.createElement(import_box13.Box, {
    as: "span",
    display: "flex",
    ...
    columnGap: "space20",
    alignItems: "center"
  }, children), showLoading ? /* @__PURE__ */ React13.createElement(import_box13.Box, {
    as: "span",
    position: "absolute",
    top: 0,
    right: 0,
  ...
  }, /* @__PURE__ */ React13.createElement(import_spinner.Spinner, {
    decorative: false,
...
var Button = React13.forwardRef((_a, ref) => {
  ...
  const arrowIconStyles = import_animation_library.useSpring({
  ...
  const externalLinkProps = props.href != null ? import_anchor.secureExternalLink(props.href) : null;
  let injectIconChildren = children;
  if (props.as === "a" && props.href != null && typeof children === "string" && variant !== "reset") {
    injectIconChildren = /* @__PURE__ */ React13.createElement(React13.Fragment, null, children, externalLinkProps != null ? /* @__PURE__ */ React13.createElement(import_LinkExternalIcon.LinkExternalIcon, {
      decorative: false,
      title: "link takes you to an external page"
    }) : /* @__PURE__ */ React13.createElement(AnimatedBox, {
      style: arrowIconStyles
    }, /* @__PURE__ */ React13.createElement(import_ArrowForwardIcon.ArrowForwardIcon, {
      decorative: true
    })));
  }
  return /* @__PURE__ */ React13.createElement(ButtonComponent, __assign(__assign(__assign({}, externalLinkProps), rest), {
    onMouseEnter: (event) => {
    ...
    style: void 0,
    ref
  }), /* @__PURE__ */ React13.createElement(ButtonContents, {
    buttonState,
    showLoading,
    variant
  }, injectIconChildren));
