...
var source = createContext(createSource());
...
var UIDFork = function(_a) {
  ...
  return createElement(UIDConsumer, null, function(id) {
    return createElement(source.Provider, {value: createSource(id + "-" + prefix)}, children);
  });
};
var UIDConsumer = function(_a) {
  var name = _a.name, children = _a.children;
  return createElement(source.Consumer, null, function(value) {
    return createElement(UID, {name, idSource: value, children});
  });
};
...
var useUIDState = function() {
  ...
  return useState(generateUID2(useContext(source)));
};
var useUID = function() {
