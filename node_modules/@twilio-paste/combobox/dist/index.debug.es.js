...
var ComboboxInputSelect = forwardRef((_a, ref) => {
  var props2 = __rest(_a, []);
  return /* @__PURE__ */ createElement(InputElement, __assign({
...
var ComboboxInputWrapper = forwardRef2((_a, ref) => {
  var {children} = _a, props2 = __rest(_a, ["children"]);
  return /* @__PURE__ */ createElement2(Box, __assign(__assign({}, safelySpreadBoxProps(props2)), {
    display: "flex",
    position: "relative",
    width: "100%",
    ref
...
var ComboboxListbox = forwardRef3((_a, ref) => {
  var {children, element = "COMBOBOX"} = _a, props2 = __rest(_a, ["children", "element"]);
  return /* @__PURE__ */ createElement3(Box2, __assign(__assign({}, safelySpreadBoxProps2(props2)), {
    as: "div",
...
var ComboboxListboxOption = forwardRef4((_a, ref) => {
  ...
  return /* @__PURE__ */ createElement4(Box3, __assign(__assign(__assign(__assign({}, safelySpreadBoxProps3(props2)), {
    as: "li",
    ...
    cursor: "pointer",
    ref
  }), virtualItemStyles), VariantStyles[variant]), /* @__PURE__ */ createElement4(Text, {
    as: "span",
    color: "colorText",
...
var ComboboxListboxGroup = forwardRef5(({children, element = "COMBOBOX", groupName, groupLabelTemplate}, ref) => {
  return /* @__PURE__ */ createElement5(Box4, {
    ...
    padding: "space0",
    listStyleType: "none"
  }, groupName ? /* @__PURE__ */ createElement5(Box4, {
    as: "li",
    role: "presentation",
    paddingY: "space30",
    paddingX: "space70",
    element: `${element}_GROUPNAME`
  }, /* @__PURE__ */ createElement5(Text2, {
    as: "span",
...
var ComboboxItems = ({
  ...
  const templatizedItems = useMemo(() => {
  ...
  if (groupItemsBy == null) {
    return /* @__PURE__ */ createElement6(ComboboxListboxGroup, {
      element
    }, /* @__PURE__ */ createElement6("li", {
      role: "presentation",
      key: "total-size",
      ...
      return /* @__PURE__ */ createElement6(ComboboxListboxOption, __assign(__assign({}, getItemProps({item, index: virtualItemIndex, ref: virtualItem.measureRef})), {
        element,
  ...
  return /* @__PURE__ */ createElement6(Fragment, null, groupedItemKeys.map((groupedItemKey) => {
    ...
    return /* @__PURE__ */ createElement6(ComboboxListboxGroup, {
      ...
      groupLabelTemplate
    }, groupedItems[groupedItemKey].map((item) => /* @__PURE__ */ createElement6(ComboboxListboxOption, __assign(__assign({}, getItemProps({item, index: item.index})), {
      element,
...
var Combobox = forwardRef6((_a, ref) => {
  var {
    autocomplete,
    disabled,
    element = "COMBOBOX",
  ...
  const defaultState = useComboboxPrimitive(__assign(__assign(__assign(__assign({
    initialSelectedItem,
    items,
    onHighlightedIndexChange: useCallback((changes) => {
  ...
  return /* @__PURE__ */ createElement7(Box5, {
    position: "relative",
    element: `${element}_WRAPPER`
  }, /* @__PURE__ */ createElement7(Label, __assign({
    disabled,
    required,
    variant
  }, getLabelProps()), labelText), /* @__PURE__ */ createElement7(InputBox, {
    disabled,
    element,
    hasError,
    insertBefore,
    insertAfter,
    variant
  }, /* @__PURE__ */ createElement7(ComboboxInputWrapper, __assign({}, getComboboxProps({role: "combobox"})), /* @__PURE__ */ createElement7(ComboboxInputSelect, __assign(__assign(__assign(__assign({}, getToggleButtonProps({tabIndex: 0})), getInputProps(__assign({disabled, required, ref}, props2))), !autocomplete ? {onChange: (event) => event.preventDefault()} : void 0), {
    autocomplete,
    "aria-describedby": helpTextId,
    element: `${element}_ELEMENT`
  })), !autocomplete && /* @__PURE__ */ createElement7(InputChevronWrapper, {
    element: `${element}_CHEVRON_WRAPPER`
  }, /* @__PURE__ */ createElement7(ChevronDownIcon, {
    "aria-hidden": "true",
    decorative: true,
    color: iconColor,
    size: "sizeIcon30"
  })))), /* @__PURE__ */ createElement7(ComboboxListbox, __assign({
    hidden: !isOpen,
    element
  }, getMenuProps({ref: parentRef})), /* @__PURE__ */ createElement7(ComboboxItems, {
    items,
    element,
    getItemProps,
    highlightedIndex,
    ...
    totalSize,
    virtualItems
  })), helpText && /* @__PURE__ */ createElement7(HelpText, {
    id: helpTextId,
...
Combobox.propTypes = {
  autocomplete: bool2,
  element: string3,
  groupItemsBy: string3,
  helpText: oneOfType([string3, node5]),
  initialIsOpen: bool2,
  initialSelectedItem: oneOfType([string3, object]),
  items: arrayOf(any).isRequired,
  itemToString: func,
  labelText: oneOfType([string3, node5]).isRequired,
  onHighlightedIndexChange: func,
  onInputValueChange: func,
  onIsOpenChange: func,
  onSelectedItemChange: func,
  optionTemplate: func,
  selectedItem: oneOfType([string3, object])
};
export {
  Combobox,
