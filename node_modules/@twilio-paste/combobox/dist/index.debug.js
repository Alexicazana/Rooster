...
__export(exports, {
  ...
  useCombobox: () => import_combobox_primitive2.useComboboxPrimitive
});
var import_combobox_primitive2 = __toModule(require("@twilio-paste/combobox-primitive"));
...
var import_combobox_primitive = __toModule(require("@twilio-paste/combobox-primitive"));
...
var import_input = __toModule(require("@twilio-paste/input"));
var ComboboxInputSelect = React2.forwardRef((_a, ref) => {
  var props2 = __rest(_a, []);
  return /* @__PURE__ */ React2.createElement(import_input.InputElement, __assign({
...
var ComboboxInputWrapper = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(import_box.Box, __assign(__assign({}, import_box.safelySpreadBoxProps(props2)), {
    display: "flex",
    position: "relative",
    width: "100%",
    ref
...
var ComboboxListbox = React4.forwardRef((_a, ref) => {
  var {children, element = "COMBOBOX"} = _a, props2 = __rest(_a, ["children", "element"]);
  return /* @__PURE__ */ React4.createElement(import_box2.Box, __assign(__assign({}, import_box2.safelySpreadBoxProps(props2)), {
    as: "div",
...
var ComboboxListboxOption = React5.forwardRef((_a, ref) => {
  var {children, element = "COMBOBOX", highlighted, variant = "default", startHeight} = _a, props2 = __rest(_a, ["children", "element", "highlighted", "variant", "startHeight"]);
  ...
  return /* @__PURE__ */ React5.createElement(import_box3.Box, __assign(__assign(__assign(__assign({}, import_box3.safelySpreadBoxProps(props2)), {
    as: "li",
    ...
    cursor: "pointer",
    ref
  }), virtualItemStyles), VariantStyles[variant]), /* @__PURE__ */ React5.createElement(import_text.Text, {
    as: "span",
    color: "colorText",
...
var ComboboxItems = ({
  ...
  const uidSeed = import_uid_library.useUIDSeed();
  ...
  if (groupItemsBy == null) {
    return /* @__PURE__ */ React7.createElement(ComboboxListboxGroup, {
      ...
      return /* @__PURE__ */ React7.createElement(ComboboxListboxOption, __assign(__assign({}, getItemProps({item, index: virtualItemIndex, ref: virtualItem.measureRef})), {
        element,
  ...
  return /* @__PURE__ */ React7.createElement(React7.Fragment, null, groupedItemKeys.map((groupedItemKey) => {
    ...
    return /* @__PURE__ */ React7.createElement(ComboboxListboxGroup, {
      ...
      groupLabelTemplate
    }, groupedItems[groupedItemKey].map((item) => /* @__PURE__ */ React7.createElement(ComboboxListboxOption, __assign(__assign({}, getItemProps({item, index: item.index})), {
      element,
...
var Combobox = React8.forwardRef((_a, ref) => {
  var {
    autocomplete,
    disabled,
    element = "COMBOBOX",
  ...
  const parentRef = React8.useRef(null);
  const helpTextId = import_uid_library2.useUID();
  const {scrollToIndex, virtualItems, totalSize} = useVirtual({
    size: items.length,
    parentRef,
    estimateSize: React8.useCallback(() => 36, []),
    overscan: 4,
    paddingStart: import_theme.remToPx(theme.space.space30, "number")
  });
  const defaultState = import_combobox_primitive.useComboboxPrimitive(__assign(__assign(__assign(__assign({
    initialSelectedItem,
    items,
  ...
  return /* @__PURE__ */ React8.createElement(import_box5.Box, {
    position: "relative",
    element: `${element}_WRAPPER`
  }, /* @__PURE__ */ React8.createElement(import_label.Label, __assign({
    disabled,
    required,
    variant
  }, getLabelProps()), labelText), /* @__PURE__ */ React8.createElement(import_input_box.InputBox, {
    disabled,
    element,
    hasError,
    insertBefore,
    insertAfter,
    variant
  }, /* @__PURE__ */ React8.createElement(ComboboxInputWrapper, __assign({}, getComboboxProps({role: "combobox"})), /* @__PURE__ */ React8.createElement(ComboboxInputSelect, __assign(__assign(__assign(__assign({}, getToggleButtonProps({tabIndex: 0})), getInputProps(__assign({disabled, required, ref}, props2))), !autocomplete ? {onChange: (event) => event.preventDefault()} : void 0), {
    autocomplete,
    "aria-describedby": helpTextId,
    element: `${element}_ELEMENT`
  })), !autocomplete && /* @__PURE__ */ React8.createElement(import_input_box.InputChevronWrapper, {
    element: `${element}_CHEVRON_WRAPPER`
  }, /* @__PURE__ */ React8.createElement(import_ChevronDownIcon.ChevronDownIcon, {
    "aria-hidden": "true",
    decorative: true,
    color: iconColor,
    size: "sizeIcon30"
  })))), /* @__PURE__ */ React8.createElement(ComboboxListbox, __assign({
    hidden: !isOpen,
    element
  }, getMenuProps({ref: parentRef})), /* @__PURE__ */ React8.createElement(ComboboxItems, {
    items,
    element,
    getItemProps,
    highlightedIndex,
    ...
    totalSize,
    virtualItems
  })), helpText && /* @__PURE__ */ React8.createElement(import_help_text.HelpText, {
    id: helpTextId,
