...
var PasteStyleProps = import_styling_library.system({
  color: {
    property: "color",
    scale: "textColors"
  },
...
var getPseudoStyles = (props) => {
  ...
  return import_styling_library.css(pseudoStyles);
};
var getCustomElementStyles = (props) => {
  if (props != null && props.theme != null && props.theme.elements != null) {
    ...
    if (themeElements[targetElement] != null) {
      ...
      const computedStyles = import_styling_library.css(elementOverrides)(props);
      const {variants} = computedStyles, elementStyles = __rest(computedStyles, ["variants"]);
      let variantStyles = {};
...
// src/index.tsx
var StyledText = import_styling_library2.styled.div({
  margin: 0,
  padding: 0
}, import_styling_library2.compose(import_styling_library2.boxShadow, import_styling_library2.display, import_styling_library2.overflow, import_styling_library2.position, import_styling_library2.space, import_styling_library2.typography, import_styling_library2.verticalAlign, PasteStyleProps), getPseudoStyles, getCustomElementStyles);
var Text = React.forwardRef((_a, ref) => {
  var {children, color = "colorText", fontSize = "fontSize30", lineHeight = "lineHeight30", element = "TEXT"} = _a, props = __rest(_a, ["children", "color", "fontSize", "lineHeight", "element"]);
