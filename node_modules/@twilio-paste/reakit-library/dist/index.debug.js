...
var SystemContext = /* @__PURE__ */ import_react.createContext({});
...
var useCreateElement = function useCreateElement2(type, props, children) {
  ...
  var context = import_react2.useContext(SystemContext);
  ...
  return /* @__PURE__ */ import_react2.createElement(type, props, children);
};
...
function forwardRef(component) {
  return /* @__PURE__ */ import_react3.forwardRef(component);
}
function memo(component, propsAreEqual9) {
  return /* @__PURE__ */ import_react3.memo(component, propsAreEqual9);
}
...
function useToken(token, defaultValue) {
  import_react4.useDebugValue(token);
  var context = import_react4.useContext(SystemContext);
...
function useProps(name, options, htmlProps) {
  ...
  import_react5.useDebugValue(hookName);
...
function useOptions(name, options, htmlProps) {
  ...
  import_react6.useDebugValue(hookName);
  var useHook = useToken(hookName);
  if (useHook) {
...
function useForkRef(refA, refB) {
  return import_react8.useMemo(function() {
...
function useLiveRef(value) {
  var ref = import_react12.useRef(value);
...
function useFocusOnMouseDown() {
  if (!isSafariOrFirefoxOnMac)
    return void 0;
  var _React$useState = import_react13.useState(null), tabbable = _React$useState[0], scheduleFocus = _React$useState[1];
  import_react13.useEffect(function() {
    if (!tabbable)
      return;
    focusIfNeeded(tabbable);
    scheduleFocus(null);
  }, [tabbable]);
  var onMouseDown = import_react13.useCallback(function(event) {
...
function useDisableEvent(htmlEventRef, disabled) {
  return import_react13.useCallback(function(event) {
...
var useTabbable = createHook({
  ...
  useProps: function useProps2(options, _ref2) {
    ...
    var ref = import_react13.useRef(null);
    ...
    var _React$useState2 = import_react13.useState(true), nativeTabbable = _React$useState2[0], setNativeTabbable = _React$useState2[1];
    var _React$useState3 = import_react13.useState(true), supportsDisabled = _React$useState3[0], setSupportsDisabled = _React$useState3[1];
...
var useClickable = createHook({
  ...
  useProps: function useProps3(options, _ref2) {
    ...
    var _React$useState = import_react14.useState(false), active = _React$useState[0], setActive = _React$useState[1];
    var onKeyDownRef = useLiveRef(htmlOnKeyDown);
    var onKeyUpRef = useLiveRef(htmlOnKeyUp);
    var onKeyDown = import_react14.useCallback(function(event) {
    ...
    var onKeyUp = import_react14.useCallback(function(event) {
...
var useButton = createHook({
  ...
  useProps: function useProps4(_, _ref) {
    ...
    var ref = import_react15.useRef(null);
    var _React$useState = import_react15.useState(void 0), role = _React$useState[0], setRole = _React$useState[1];
    var _React$useState2 = import_react15.useState("button"), type = _React$useState2[0], setType = _React$useState2[1];
...
var useCheckbox = createHook({
  ...
  useProps: function useProps5(options, _ref3) {
    ...
    var _React$useState = import_react16.useState(true), isNativeCheckbox = _React$useState[0], setIsNativeCheckbox = _React$useState[1];
    ...
    var onChange = import_react16.useCallback(function(event) {
      var element = event.currentTarget;
      if (options.disabled) {
        event.stopPropagation();
        event.preventDefault();
    ...
    var onClick = import_react16.useCallback(function(event) {
...
function useSealedState(initialState) {
  var _React$useState = import_react17.useState(initialState), sealed = _React$useState[0];
  return sealed;
}
...
function useUpdateEffect(effect4, deps) {
  var mounted = import_react18.useRef(false);
...
function useKeyboardEventProxy(virtual, currentItem, htmlEventHandler) {
  ...
  return import_react19.useCallback(function(event) {
...
function useActiveElementRef(elementRef) {
  var activeElementRef = import_react19.useRef(null);
...
function useScheduleUserFocus(currentItem) {
  ...
  var _React$useReducer = import_react19.useReducer(function(n) {
    return n + 1;
...
var useComposite = createHook({
  ...
  useProps: function useProps6(options, _ref) {
    ...
    var ref = import_react19.useRef(null);
    var currentItem = findEnabledItemById(options.items, options.currentId);
    var previousElementRef = import_react19.useRef(null);
    ...
    var onFocusCapture = import_react19.useCallback(function(event) {
    ...
    var onFocus = import_react19.useCallback(function(event) {
    ...
    var onBlurCapture = import_react19.useCallback(function(event) {
    ...
    var onKeyDown = import_react19.useCallback(function(event) {
...
var unstable_IdContext = /* @__PURE__ */ import_react20.createContext(generateRandomString);
...
var unstable_useId = createHook({
  ...
  useOptions: function useOptions6(options, htmlProps) {
    var generateId = import_react21.useContext(unstable_IdContext);
    var _React$useState = import_react21.useState(function() {
    ...
    var baseId = import_react21.useMemo(function() {
...
var useCompositeItem = createHook({
  ...
  useProps: function useProps8(options, _ref) {
    ...
    var ref = import_react22.useRef(null);
    var id = options.id;
    var trulyDisabled = options.disabled && !options.focusable;
    var isCurrentItem = options.currentId === id;
    var isCurrentItemRef = useLiveRef(isCurrentItem);
    var hasFocusedComposite = import_react22.useRef(false);
    ...
    var onMouseDown = import_react22.useCallback(function(event) {
      var _onMouseDownRef$curre;
      (_onMouseDownRef$curre = onMouseDownRef.current) === null || _onMouseDownRef$curre === void 0 ? void 0 : _onMouseDownRef$curre.call(onMouseDownRef, event);
      setUserFocus(event.currentTarget, true);
    }, []);
    var onFocus = import_react22.useCallback(function(event) {
    ...
    var onBlurCapture = import_react22.useCallback(function(event) {
      var _onBlurCaptureRef$cur;
      (_onBlurCaptureRef$cur = onBlurCaptureRef.current) === null || _onBlurCaptureRef$cur === void 0 ? void 0 : _onBlurCaptureRef$cur.call(onBlurCaptureRef, event);
      if (event.defaultPrevented)
        return;
    ...
    var onKeyDown = import_react22.useCallback(function(event) {
      var _onKeyDownRef$current;
      if (!isSelfTarget(event))
        return;
      var isVertical = options.orientation !== "horizontal";
    ...
    var onClick = import_react22.useCallback(function(event) {
      var _onClickRef$current;
      (_onClickRef$current = onClickRef.current) === null || _onClickRef$current === void 0 ? void 0 : _onClickRef$current.call(onClickRef, event);
      if (event.defaultPrevented)
        return;
...
var useCompositeGroup = createHook({
  ...
  useProps: function useProps10(options, _ref) {
    var htmlRef = _ref.ref, htmlProps = _objectWithoutPropertiesLoose3(_ref, ["ref"]);
    var ref = import_react23.useRef(null);
    var id = options.id;
    useIsomorphicEffect(function() {
...
function unstable_useIdState(initialState) {
  ...
  var generateId = import_react24.useContext(unstable_IdContext);
  var idCountRef = import_react24.useRef(0);
  var _React$useState = import_react24.useState(function() {
...
function useIntersectionObserver(items, setItems) {
  var previousItems = import_react25.useRef([]);
...
function useAction(fn2) {
  return import_react25.useCallback(fn2, []);
}
function useIsUnmountedRef() {
  var isUnmountedRef = import_react25.useRef(false);
  useIsomorphicEffect(function() {
    return function() {
...
function useCompositeState(initialState) {
  ...
  var _React$useReducer = import_react25.useReducer(reducer, {
  ...
  var _React$useState = import_react25.useState(false), hasActiveWidget = _React$useState[0], setHasActiveWidget = _React$useState[1];
  var isUnmountedRef = useIsUnmountedRef();
  var setItems = import_react25.useCallback(function(items) {
    return dispatch({
      type: "setItems",
      items
    });
...
function useLastValue(value) {
  var lastValue = import_react26.useRef(null);
  useIsomorphicEffect(function() {
...
function useDisclosureState(initialState) {
  ...
  var _React$useState = import_react26.useState(initialVisible), visible = _React$useState[0], setVisible = _React$useState[1];
  var _React$useState2 = import_react26.useState(initialAnimated), animated = _React$useState2[0], setAnimated = _React$useState2[1];
  var _React$useState3 = import_react26.useState(false), animating = _React$useState3[0], setAnimating = _React$useState3[1];
  ...
  var show2 = import_react26.useCallback(function() {
    return setVisible(true);
  }, []);
  var hide3 = import_react26.useCallback(function() {
    return setVisible(false);
  }, []);
  var toggle = import_react26.useCallback(function() {
    return setVisible(function(v) {
      return !v;
    });
  }, []);
  var stopAnimation = import_react26.useCallback(function() {
    return setAnimating(false);
  }, []);
...
function useDialogState(initialState) {
  ...
  var _React$useState = import_react27.useState(initialModal), modal = _React$useState[0], setModal = _React$useState[1];
  var disclosureRef = import_react27.useRef(null);
...
function usePopoverState(initialState) {
  ...
  var popper2 = import_react28.useRef(null);
  var referenceRef = import_react28.useRef(null);
  var popoverRef = import_react28.useRef(null);
  var arrowRef = import_react28.useRef(null);
  var _React$useState = import_react28.useState(sealedPlacement), originalPlacement = _React$useState[0], place = _React$useState[1];
  var _React$useState2 = import_react28.useState(sealedPlacement), placement = _React$useState2[0], setPlacement = _React$useState2[1];
  var _React$useState3 = import_react28.useState(sealedOffset || [0, gutter]), offset2 = _React$useState3[0];
  var _React$useState4 = import_react28.useState({}), popoverStyles = _React$useState4[0], setPopoverStyles = _React$useState4[1];
  var _React$useState5 = import_react28.useState({}), arrowStyles = _React$useState5[0], setArrowStyles = _React$useState5[1];
  var dialog = useDialogState(_objectSpread23({
    modal
  }, sealed));
  var update = import_react28.useCallback(function() {
    if (popper2.current) {
  ...
  var updateState = import_react28.useCallback(function(state) {
    if (state.placement) {
...
var useDisclosureContent = createHook({
  ...
  useProps: function useProps11(options, _ref) {
    ...
    var _React$useState = import_react29.useState(null), transition = _React$useState[0], setTransition = _React$useState[1];
    ...
    var raf = import_react29.useRef(0);
    ...
    var onEnd = import_react29.useCallback(function(event) {
      if (!isSelfTarget(event))
        return;
      if (!animating)
        return;
    ...
    var onTransitionEnd = import_react29.useCallback(function(event) {
    ...
    var onAnimationEnd = import_react29.useCallback(function(event) {
...
var PortalContext = /* @__PURE__ */ import_react30.createContext(getBodyElement());
function Portal(_ref) {
  var children = _ref.children;
  var context = import_react30.useContext(PortalContext) || getBodyElement();
  var _React$useState = import_react30.useState(function() {
    if (canUseDOM) {
  ...
  if (hostNode) {
    return /* @__PURE__ */ import_react_dom.createPortal(/* @__PURE__ */ import_react30.createElement(PortalContext.Provider, {
      value: hostNode
    }, children), hostNode);
  }
  return null;
...
var MenuContext = /* @__PURE__ */ import_react31.createContext(null);
function useMenuContext(menuRef, role, options) {
  var orphan = "unstable_orphan" in options && options.unstable_orphan;
  var parent = import_react31.useContext(MenuContext);
  var _React$useState = import_react31.useState([]), children = _React$useState[0], setChildren = _React$useState[1];
  var _ref = parent || {}, addChildToParent = _ref.addChild, removeChildFromParent = _ref.removeChild;
  var addChild = import_react31.useCallback(function(ref) {
    return setChildren(function(refs) {
      return [].concat(refs, [ref]);
    });
  }, []);
  var removeChild = import_react31.useCallback(function(ref) {
    return setChildren(function(refs) {
  ...
  var providerValue = import_react31.useMemo(function() {
    return {
  ...
  var wrapElement = import_react31.useCallback(function(element) {
    return /* @__PURE__ */ import_react31.createElement(MenuContext.Provider, {
      value: providerValue
    }, element);
  }, [providerValue]);
  return wrapElement;
...
var DialogBackdropContext = /* @__PURE__ */ import_react32.createContext(void 0);
...
function useDisclosureRef(dialogRef, options) {
  var ref = import_react33.useRef(null);
  var animating = !!(options.animated && options.animating);
...
function usePortalRef(dialogRef, options) {
  var portalRef = import_react33.useRef(null);
  import_react33.useEffect(function() {
    var dialog = dialogRef.current;
...
function useFocusTrap(dialogRef, visibleModals, options) {
  ...
  var beforeElement = import_react33.useRef(null);
  var afterElement = import_react33.useRef(null);
  import_react33.useEffect(function() {
    if (!shouldTrap)
      return void 0;
...
var DialogContext = /* @__PURE__ */ import_react33.createContext({});
function useNestedDialogs(dialogRef, options) {
  var context = import_react33.useContext(DialogContext);
  var _React$useState = import_react33.useState([]), dialogs = _React$useState[0], setDialogs = _React$useState[1];
  var _React$useState2 = import_react33.useState(dialogs), visibleModals = _React$useState2[0], setVisibleModals = _React$useState2[1];
  var addDialog = import_react33.useCallback(function(ref) {
  ...
  var removeDialog = import_react33.useCallback(function(ref) {
  ...
  var showDialog = import_react33.useCallback(function(ref) {
  ...
  var hideDialog = import_react33.useCallback(function(ref) {
  ...
  var providerValue = import_react33.useMemo(function() {
    return {
  ...
  var wrap = import_react33.useCallback(function(element) {
    return /* @__PURE__ */ import_react33.createElement(DialogContext.Provider, {
      value: providerValue
    }, element);
  }, [providerValue]);
  return {
...
function useMouseDownRef(dialogRef, options) {
  var mouseDownRef = import_react33.useRef();
  import_react33.useEffect(function() {
    if (!options.visible)
      return void 0;
...
function useFocusOnBlur(dialogRef, options) {
  var _React$useReducer = import_react33.useReducer(function(n) {
    return n + 1;
  ...
  var onBlur = import_react33.useCallback(function(event) {
    if (!options.visible)
      return;
    var nextActiveElement = getNextActiveElementOnBlur(event);
...
var useDialog = createHook({
  ...
  useProps: function useProps12(options, _ref2) {
    ...
    var dialog = import_react33.useRef(null);
    var backdrop = import_react33.useContext(DialogBackdropContext);
    ...
    var onKeyDown = import_react33.useCallback(function(event) {
      var _onKeyDownRef$current;
      (_onKeyDownRef$current = onKeyDownRef.current) === null || _onKeyDownRef$current === void 0 ? void 0 : _onKeyDownRef$current.call(onKeyDownRef, event);
      if (event.defaultPrevented)
        return;
    ...
    var wrapElement = import_react33.useCallback(function(element) {
      element = wrap(element);
      if (options.modal && !hasBackdrop) {
        element = /* @__PURE__ */ import_react33.createElement(Portal, null, element);
      }
      if (htmlWrapElement) {
        element = htmlWrapElement(element);
      }
      return /* @__PURE__ */ import_react33.createElement(MenuContext.Provider, {
        value: null
      }, element);
...
var useDisclosure = createHook({
  ...
  useProps: function useProps14(options, _ref) {
    ...
    var onClick = import_react35.useCallback(function(event) {
...
var useDialogDisclosure = createHook({
  ...
  useProps: function useProps15(options, _ref) {
    ...
    var ref = import_react36.useRef(null);
    var onClickRef = useLiveRef(htmlOnClick);
    var _React$useState = import_react36.useState(false), expanded = _React$useState[0], setExpanded = _React$useState[1];
    ...
    var onClick = import_react36.useCallback(function(event) {
      var _onClickRef$current;
      (_onClickRef$current = onClickRef.current) === null || _onClickRef$current === void 0 ? void 0 : _onClickRef$current.call(onClickRef, event);
      if (event.defaultPrevented)
        return;
...
function useInitialChecked(options) {
  var _React$useState = import_react37.useState(function() {
    return getChecked2(options);
  }), initialChecked = _React$useState[0];
  var _React$useState2 = import_react37.useState(options.currentId), initialCurrentId = _React$useState2[0];
...
var useRadio = createHook({
  ...
  useProps: function useProps16(options, _ref3) {
    var htmlRef = _ref3.ref, htmlOnChange = _ref3.onChange, htmlOnClick = _ref3.onClick, htmlProps = _objectWithoutPropertiesLoose3(_ref3, ["ref", "onChange", "onClick"]);
    var ref = import_react37.useRef(null);
    var _React$useState3 = import_react37.useState(true), isNativeRadio = _React$useState3[0], setIsNativeRadio = _React$useState3[1];
    ...
    var onChange = import_react37.useCallback(function(event) {
    ...
    var onClick = import_react37.useCallback(function(event) {
      var _onClickRef$current;
      (_onClickRef$current = onClickRef.current) === null || _onClickRef$current === void 0 ? void 0 : _onClickRef$current.call(onClickRef, event);
      if (event.defaultPrevented)
        return;
...
function useShortcuts(menuRef, _ref, timeout) {
  ...
  var _React$useState = import_react38.useState(""), keys = _React$useState[0], setKeys = _React$useState[1];
  import_react38.useEffect(function() {
    if (!keys)
      return void 0;
...
var useMenuBar = createHook({
  ...
  useProps: function useProps17(options, _ref) {
    ...
    var ref = import_react38.useRef(null);
    var wrap = useMenuContext(ref, role, options);
    useShortcuts(ref, options);
    var wrapElement = import_react38.useCallback(function(element) {
      element = wrap(element);
      if (htmlWrapElement) {
...
function usePlacementDir(placement) {
  return import_react39.useMemo(function() {
...
var useMenu = createHook({
  ...
  useOptions: function useOptions11(options) {
    var parent = import_react39.useContext(MenuContext);
  ...
  useProps: function useProps18(options, _ref) {
    ...
    var onKeyDown = import_react39.useCallback(function(event) {
      var _onKeyDownRef$current;
      (_onKeyDownRef$current = onKeyDownRef.current) === null || _onKeyDownRef$current === void 0 ? void 0 : _onKeyDownRef$current.call(onKeyDownRef, event);
      if (event.defaultPrevented)
        return;
...
function useMenuBarState(initialState) {
  ...
  var _React$useState = import_react40.useState(initialValues), values = _React$useState[0], setValues = _React$useState[1];
  ...
  return _objectSpread23(_objectSpread23({}, composite), {}, {
    ...
    unstable_setValue: import_react40.useCallback(function(name, value) {
...
var useMenuButton = createHook({
  ...
  useProps: function useProps20(options, _ref) {
    ...
    var parent = import_react42.useContext(MenuContext);
    var ref = import_react42.useRef(null);
    var hasPressedMouse = import_react42.useRef(false);
    ...
    var onMouseDownRef = useLiveRef(htmlOnMouseDown);
    var onKeyDown = import_react42.useCallback(function(event) {
      var _onKeyDownRef$current;
      if (event.key === "Escape") {
        var _options$hide;
        (_options$hide = options.hide) === null || _options$hide === void 0 ? void 0 : _options$hide.call(options);
    ...
    var onMouseEnter = import_react42.useCallback(function(event) {
    ...
    var onMouseDown = import_react42.useCallback(function(event) {
      var _onMouseDownRef$curre;
      hasPressedMouse.current = true;
      (_onMouseDownRef$curre = onMouseDownRef.current) === null || _onMouseDownRef$curre === void 0 ? void 0 : _onMouseDownRef$curre.call(onMouseDownRef, event);
    }, []);
    var onFocus = import_react42.useCallback(function(event) {
      var _onFocusRef$current;
      (_onFocusRef$current = onFocusRef.current) === null || _onFocusRef$current === void 0 ? void 0 : _onFocusRef$current.call(onFocusRef, event);
      if (event.defaultPrevented)
        return;
    ...
    var onClick = import_react42.useCallback(function(event) {
      var _onClickRef$current;
      (_onClickRef$current = onClickRef.current) === null || _onClickRef$current === void 0 ? void 0 : _onClickRef$current.call(onClickRef, event);
      if (event.defaultPrevented)
        return;
...
function useTransitToSubmenu(menu, htmlOnMouseEnter) {
  var onMouseEnterRef = useLiveRef(htmlOnMouseEnter);
  var enterPointRef = import_react43.useRef(null);
  var submenuTopPointRef = import_react43.useRef(null);
  var submenuBottomPointRef = import_react43.useRef(null);
  var previousClientX = import_react43.useRef(0);
  var previousClientY = import_react43.useRef(0);
  var assignSubmenuAnchorPoints = import_react43.useCallback(function(event) {
  ...
  var isMouseInTransitToSubmenu = import_react43.useCallback(function(event) {
  ...
  var onMouseEnter = import_react43.useCallback(function(event) {
    var _onMouseEnterRef$curr;
    (_onMouseEnterRef$curr = onMouseEnterRef.current) === null || _onMouseEnterRef$curr === void 0 ? void 0 : _onMouseEnterRef$curr.call(onMouseEnterRef, event);
    if (event.defaultPrevented)
      return;
...
var useMenuItem = createHook({
  ...
  useProps: function useProps22(options, _ref) {
    ...
    var menu = import_react43.useContext(MenuContext);
    ...
    var onMouseMove = import_react43.useCallback(function(event) {
    ...
    var onMouseLeave = import_react43.useCallback(function(event) {
...
var useMenuItemCheckbox = createHook({
  ...
  useOptions: function useOptions12(options) {
    var setState = import_react44.useCallback(function(value) {
...
var useMenuItemRadio = createHook({
  ...
  useOptions: function useOptions13(options) {
    var setState = import_react45.useCallback(function(value) {
      return options.unstable_setValue(options.name, value);
    }, [options.unstable_setValue, options.name]);
    return _objectSpread23(_objectSpread23({}, options), {}, {
...
function useMenuState(initialState) {
  ...
  var parent = import_react46.useContext(MenuContext);
  ...
  import_react46.useEffect(function() {
    if (!popover.visible) {
      menuBar.reset();
    }
...
function useTabPanelId(options) {
  return import_react47.useMemo(function() {
...
var useTab = createHook({
  ...
  useProps: function useProps26(options, _ref2) {
    ...
    var onClickRef = useLiveRef(htmlOnClick);
    var onFocusRef = useLiveRef(htmlOnFocus);
    var onClick = import_react47.useCallback(function(event) {
    ...
    var onFocus = import_react47.useCallback(function(event) {
...
function useTabState(initialState) {
  ...
  var _React$useState = import_react50.useState(initialSelectedId), selectedId = _React$useState[0], setSelectedId = _React$useState[1];
  var select = import_react50.useCallback(function(id) {
    composite.move(id);
    setSelectedId(id);
  }, [composite.move]);
  import_react50.useEffect(function() {
    if (selectedId === null)
      return;
  ...
  return _objectSpread23(_objectSpread23({}, composite), {}, {
    ...
    select,
    setSelectedId,
    registerPanel: import_react50.useCallback(function(panel) {
      return panels.registerItem(panel);
    }, [panels.registerItem]),
    unregisterPanel: import_react50.useCallback(function(id) {
...
var useTooltip = createHook({
  ...
  useProps: function useProps29(options, _ref2) {
    ...
    import_react51.useEffect(function() {
    ...
    var wrapElement = import_react51.useCallback(function(element) {
      if (options.unstable_portal) {
        element = /* @__PURE__ */ import_react51.createElement(Portal, null, element);
      }
      if (htmlWrapElement) {
        return htmlWrapElement(element);
      }
...
var useTooltipReference = createHook({
  ...
  useProps: function useProps30(options, _ref) {
    ...
    var onMouseEnterRef = useLiveRef(htmlOnMouseEnter);
    var onMouseLeaveRef = useLiveRef(htmlOnMouseLeave);
    var onFocus = import_react52.useCallback(function(event) {
    ...
    var onBlur = import_react52.useCallback(function(event) {
    ...
    var onMouseEnter = import_react52.useCallback(function(event) {
    ...
    var onMouseLeave = import_react52.useCallback(function(event) {
...
function useTooltipState(initialState) {
  ...
  var _React$useState = import_react53.useState(initialTimeout), timeout = _React$useState[0], setTimeout2 = _React$useState[1];
  var showTimeout = import_react53.useRef(null);
  var hideTimeout = import_react53.useRef(null);
  ...
  var clearTimeouts = import_react53.useCallback(function() {
  ...
  var hide3 = import_react53.useCallback(function() {
    clearTimeouts();
    popover.hide();
  ...
  var show2 = import_react53.useCallback(function() {
    clearTimeouts();
  ...
  import_react53.useEffect(function() {
