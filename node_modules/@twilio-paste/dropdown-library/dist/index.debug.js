...
// ../../../node_modules/downshift/node_modules/compute-scroll-into-view/dist/index.module.js
function t(t2) {
  return t2 != null && typeof t2 == "object" && t2.nodeType === 1;
}
function e(t2, e2) {
...
function index_module_default(e2, i) {
  ...
  for (var g = o.visualViewport ? o.visualViewport.width : innerWidth, m = o.visualViewport ? o.visualViewport.height : innerHeight, w = window.scrollX || pageXOffset, v = window.scrollY || pageYOffset, W = e2.getBoundingClientRect(), b = W.height, H = W.width, y = W.top, M = W.right, E = W.bottom, V = W.left, x = d === "start" || d === "nearest" ? y : d === "end" ? E : y + b / 2, I = u === "center" ? V + H / 2 : u === "end" ? M : V, C = [], T = 0; T < s.length; T++) {
    var k = s[T], B = k.getBoundingClientRect(), D = B.height, O = B.width, R = B.top, X = B.right, Y = B.bottom, L = B.left;
    if (l === "if-needed" && y >= 0 && V >= 0 && E <= m && M <= g && y >= R && E <= Y && V >= L && M <= X)
      return C;
    var S = getComputedStyle(k), j = parseInt(S.borderLeftWidth, 10), N = parseInt(S.borderTopWidth, 10), q = parseInt(S.borderRightWidth, 10), z = parseInt(S.borderBottomWidth, 10), A = 0, F = 0, G = "offsetWidth" in k ? k.offsetWidth - k.clientWidth - j - q : 0, J = "offsetHeight" in k ? k.offsetHeight - k.clientHeight - N - z : 0;
    if (f === k)
      A = d === "start" ? x : d === "end" ? x - m : d === "nearest" ? r(v, v + m, m, N, z, v + x, v + x + b, b) : x - m / 2, F = u === "start" ? I : u === "center" ? I - g / 2 : u === "end" ? I - g : r(w, w + g, g, j, q, w + I, w + I + H, H), A = Math.max(0, A + v), F = Math.max(0, F + w);
    else {
      A = d === "start" ? x - R - N : d === "end" ? x - Y + z + J : d === "nearest" ? r(R, Y, D, N, z + J, x, x + b, b) : x - (R + D / 2) + J / 2, F = u === "start" ? I - L - j : u === "center" ? I - (L + O / 2) + G / 2 : u === "end" ? I - X + q + G : r(L, X, O, j, q + G, I, I + H, H);
      var K = k.scrollLeft, P = k.scrollTop;
      x += P - (A = Math.max(0, Math.min(P + A, k.scrollHeight - D + J))), I += K - (F = Math.max(0, Math.min(K + F, k.scrollWidth - O + G)));
    }
    C.push({el: k, top: A, left: F});
  }
  return C;
}
  ...
  var Downshift2 = /* @__PURE__ */ function(_Component) {
    ...
    function Downshift3(_props) {
      ...
      _this.getItemProps = function(_temp7) {
        ...
        var _ref7 = _temp7 === void 0 ? {} : _temp7, onMouseMove = _ref7.onMouseMove, onMouseDown = _ref7.onMouseDown, onClick = _ref7.onClick, onPress = _ref7.onPress, index = _ref7.index, _ref7$item = _ref7.item, item = _ref7$item === void 0 ? void 0 : _ref7$item, rest = _objectWithoutPropertiesLoose(_ref7, ["onMouseMove", "onMouseDown", "onClick", "onPress", "index", "item"]);
        if (index === void 0) {
    ...
    _proto.render = function render() {
      ...
      if (this.getRootProps.called || this.props.suppressRefError) {
        ...
        return import_react.cloneElement(element, this.getRootProps(getElementProps(element)));
      }
      if (false) {
...
function useEnhancedReducer(reducer, initialState, props) {
  var prevStateRef = import_react.useRef();
  var actionRef = import_react.useRef();
  var enhancedReducer = import_react.useCallback(function(state2, action2) {
  ...
  var _useReducer = import_react.useReducer(enhancedReducer, initialState), state = _useReducer[0], dispatch = _useReducer[1];
  var propsRef = useLatestRef(props);
  var dispatchWithProps = import_react.useCallback(function(action2) {
...
function useMouseAndTouchTracker(isOpen, downshiftElementRefs, environment, handleBlur) {
  var mouseAndTouchTrackersRef = import_react.useRef({
    isMouseDown: false,
    isTouchMove: false
  });
  import_react.useEffect(function() {
...
function useGetterPropsCalledChecker() {
  var isNotProduction = false;
  var isInitialMountRef = import_react.useRef(true);
  for (var _len = arguments.length, propKeys = new Array(_len), _key = 0; _key < _len; _key++) {
    propKeys[_key] = arguments[_key];
  }
  var getterPropsCalledRef = import_react.useRef(propKeys.reduce(function(acc, propKey) {
    acc[propKey] = {};
    return acc;
  }, {}));
  import_react.useEffect(function() {
  ...
  var setGetterPropCallInfo = import_react.useCallback(function(propKey, suppressRefError, refKey, elementRef) {
    if (false) {
...
function useA11yMessageSetter(getA11yMessage, dependencyArray, _ref2) {
  var isInitialMount = _ref2.isInitialMount, previousResultCount = _ref2.previousResultCount, highlightedIndex = _ref2.highlightedIndex, items = _ref2.items, environment = _ref2.environment, rest = _objectWithoutPropertiesLoose(_ref2, ["isInitialMount", "previousResultCount", "highlightedIndex", "items", "environment"]);
  import_react.useEffect(function() {
    if (isInitialMount) {
      return;
    }
...
function useScrollIntoView(_ref3) {
  ...
  var shouldScrollRef = import_react.useRef(true);
  import_react.useEffect(function() {
...
function useControlPropsValidator(_ref4) {
  ...
  var prevPropsRef = import_react.useRef(props);
  import_react.useEffect(function() {
    if (isInitialMount) {
      return;
    }
...
var MenuKeyDownSpaceButton = 6;
var MenuKeyDownCharacter = 7;
var MenuBlur = 8;
var MenuMouseLeave = 9;
var ItemMouseMove = 10;
var ItemClick = 11;
var ToggleButtonClick = 12;
var ToggleButtonKeyDownArrowDown = 13;
var ToggleButtonKeyDownArrowUp = 14;
var ToggleButtonKeyDownCharacter = 15;
var FunctionToggleMenu = 16;
var FunctionOpenMenu = 17;
var FunctionCloseMenu = 18;
var FunctionSetHighlightedIndex = 19;
var FunctionSelectItem = 20;
var FunctionSetInputValue = 21;
var FunctionReset = 22;
...
function useSelect(userProps) {
  ...
  var toggleButtonRef = import_react.useRef(null);
  var menuRef = import_react.useRef(null);
  var itemRefs = import_react.useRef();
  itemRefs.current = {};
  var shouldBlurRef = import_react.useRef(true);
  var clearTimeoutRef = import_react.useRef(null);
  var elementIdsRef = import_react.useRef(getElementIds(props));
  var previousResultCountRef = import_react.useRef();
  var isInitialMountRef = import_react.useRef(true);
  ...
  var toggleButtonKeyDownHandlers = import_react.useMemo(function() {
    return {
      ArrowDown: function ArrowDown(event) {
        event.preventDefault();
        dispatch({
  ...
  var menuKeyDownHandlers = import_react.useMemo(function() {
    return {
      ArrowDown: function ArrowDown(event) {
        event.preventDefault();
        dispatch({
  ...
  var toggleMenu = import_react.useCallback(function() {
    dispatch({
      type: FunctionToggleMenu
    });
  }, [dispatch]);
  var closeMenu = import_react.useCallback(function() {
    dispatch({
      type: FunctionCloseMenu
    });
  }, [dispatch]);
  var openMenu = import_react.useCallback(function() {
    dispatch({
      type: FunctionOpenMenu
    });
  }, [dispatch]);
  var setHighlightedIndex = import_react.useCallback(function(newHighlightedIndex) {
    dispatch({
      type: FunctionSetHighlightedIndex,
      highlightedIndex: newHighlightedIndex
    });
  }, [dispatch]);
  var selectItem = import_react.useCallback(function(newSelectedItem) {
    dispatch({
      type: FunctionSelectItem,
      selectedItem: newSelectedItem
    });
  }, [dispatch]);
  var reset = import_react.useCallback(function() {
    dispatch({
      type: FunctionReset
    });
  }, [dispatch]);
  var setInputValue = import_react.useCallback(function(newInputValue) {
    dispatch({
      type: FunctionSetInputValue,
      inputValue: newInputValue
    });
  }, [dispatch]);
  var getLabelProps = import_react.useCallback(function(labelProps) {
    return _extends({
      id: elementIdsRef.current.labelId,
      htmlFor: elementIdsRef.current.toggleButtonId
    }, labelProps);
  }, []);
  var getMenuProps = import_react.useCallback(function(_temp, _temp2) {
    var _extends2;
  ...
  var getToggleButtonProps = import_react.useCallback(function(_temp3, _temp4) {
    var _extends3;
  ...
  var getItemProps = import_react.useCallback(function(_temp5) {
    var _extends4;
...
var InputChange = 6;
var InputBlur = 7;
var MenuMouseLeave$1 = 8;
var ItemMouseMove$1 = 9;
var ItemClick$1 = 10;
var ToggleButtonClick$1 = 11;
var FunctionToggleMenu$1 = 12;
var FunctionOpenMenu$1 = 13;
var FunctionCloseMenu$1 = 14;
var FunctionSetHighlightedIndex$1 = 15;
var FunctionSelectItem$1 = 16;
var FunctionSetInputValue$1 = 17;
...
function useControlledReducer$1(reducer, initialState, props) {
  var previousSelectedItemRef = import_react.useRef();
  var _useEnhancedReducer = useEnhancedReducer(reducer, initialState, props), state = _useEnhancedReducer[0], dispatch = _useEnhancedReducer[1];
  import_react.useEffect(function() {
...
function useCombobox(userProps) {
  ...
  var toggleButtonRef = import_react.useRef(null);
  var comboboxRef = import_react.useRef(null);
  itemRefs.current = {};
  var isInitialMountRef = import_react.useRef(true);
  var elementIdsRef = import_react.useRef(getElementIds$1(props));
  var previousResultCountRef = import_react.useRef();
  var latest = useLatestRef({
    state,
    props
  ...
  var inputKeyDownHandlers = import_react.useMemo(function() {
    return {
      ArrowDown: function ArrowDown(event) {
        event.preventDefault();
        dispatch({
  ...
  var getItemProps = import_react.useCallback(function(_temp3) {
    var _extends3, _ref4;
  ...
  var getToggleButtonProps = import_react.useCallback(function(_temp4) {
    var _extends4;
  ...
  var getInputProps = import_react.useCallback(function(_temp5, _temp6) {
    var _extends5;
  ...
  var getComboboxProps = import_react.useCallback(function(_temp7, _temp8) {
    var _extends6;
...
function useMultipleSelection(userProps) {
  ...
  var activeIndex = state.activeIndex, selectedItems = state.selectedItems;
  var isInitialMountRef = import_react.useRef(true);
  var dropdownRef = import_react.useRef(null);
  var previousSelectedItemsRef = import_react.useRef(selectedItems);
  var selectedItemRefs = import_react.useRef();
  ...
  var selectedItemKeyDownHandlers = import_react.useMemo(function() {
    var _ref;
  ...
  var dropdownKeyDownHandlers = import_react.useMemo(function() {
    var _ref2;
  ...
  var getSelectedItemProps = import_react.useCallback(function(_temp) {
    var _extends2;
  ...
  var getDropdownProps = import_react.useCallback(function(_temp2, _temp3) {
    var _extends3;
  ...
  var addSelectedItem = import_react.useCallback(function(selectedItem) {
    dispatch({
      type: FunctionAddSelectedItem,
      selectedItem
    });
  }, [dispatch]);
  var removeSelectedItem = import_react.useCallback(function(selectedItem) {
    dispatch({
      type: FunctionRemoveSelectedItem,
      selectedItem
    });
  }, [dispatch]);
  var setSelectedItems = import_react.useCallback(function(newSelectedItems) {
    dispatch({
      type: FunctionSetSelectedItems,
      selectedItems: newSelectedItems
    });
  }, [dispatch]);
  var setActiveIndex = import_react.useCallback(function(newActiveIndex) {
    dispatch({
...
// src/index.tsx
var src_default = downshift_esm_default;
