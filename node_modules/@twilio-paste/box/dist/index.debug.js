...
// src/index.tsx
var StyledBox = import_styling_library2.styled.div({
  boxSizing: "border-box"
}, import_styling_library2.compose(import_styling_library2.space, import_styling_library2.layout, import_styling_library2.flexbox, import_styling_library2.background, import_styling_library2.border, import_styling_library2.boxShadow, import_styling_library2.position, import_styling_library2.typography, PasteStyleProps), getPseudoStyles, getCustomElementStyles);
var Box = React.forwardRef((_a, ref) => {
  var {children, element = "BOX"} = _a, props = __rest(_a, ["children", "element"]);
  return /* @__PURE__ */ React.createElement(StyledBox, __assign({
