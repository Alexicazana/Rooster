...
@color-background-destructive-weaker: rgba(255, 255, 255, 0.2);
/* Warning background color */
@color-background-warning: rgb(255, 179, 122);
...
@color-background-row-striped: rgb(31, 48, 76);
/* Strongest background for primary actions or highlights */
@color-background-primary-strongest: rgb(255, 255, 255);
/* Weakest success background color */
@color-background-success-weakest: rgb(13, 58, 31);
/* Strongest background for destructive actions or highlights */
@color-background-destructive-strongest: rgb(255, 255, 255);
/* Strong error background color */
@color-background-error-strong: rgb(252, 207, 207);
...
@color-background-brand: rgb(57, 71, 98);
...
@color-background-destructive-strong: rgb(252, 207, 207);
/* Weak background for destructive actions or highlights */
@color-background-destructive-weak: rgba(255, 255, 255, 0.3);
/* Default background color for any container */
@color-background: rgb(31, 48, 76);
/* Weak background for primary actions or highlights */
@color-background-primary-weak: rgba(255, 255, 255, 0.3);
/* Stronger default background color */
@color-background-stronger: rgb(75, 86, 113);
...
@color-background-overlay: rgba(57, 71, 98, 0.8);
...
@color-border-warning-weak: rgb(244, 124, 34);
/* Warning border color */
@color-border-warning: rgb(255, 179, 122);
/* Stronger primary border color */
@color-border-primary-stronger: rgb(235, 244, 255);
/* Stronger destructive hover border color */
@color-border-destructive-stronger: rgb(254, 236, 236);
/* Weakest warning border color */
@color-border-warning-weakest: rgb(84, 25, 20);
/* Weaker primary border color */
@color-border-primary-weaker: rgba(255, 255, 255, 0.2);
/* Destructive focus border color */
@color-border-destructive-weaker: rgba(255, 255, 255, 0.2);
/* Destructive border color */
@color-border-destructive: rgb(235, 86, 86);
...
@color-border-primary: rgb(0, 140, 255);
/* Weakest primary border color */
@color-border-primary-weakest: rgba(255, 255, 255, 0.1);
/* Success border color */
@color-border-success: rgb(123, 234, 165);
/* Destructive focus border color */
@color-border-destructive-weakest: rgba(255, 255, 255, 0.1);
/* Strongest destructive hover border color */
@color-border-destructive-strongest: rgb(255, 255, 255);
/* Strongest primary border color */
@color-border-primary-strongest: rgb(255, 255, 255);
/* Weakest success border color */
@color-border-success-weakest: rgb(13, 58, 31);
/* Strong border color */
@color-border-strong: rgb(136, 145, 170);
/* Weak border color */
@color-border-weak: rgb(75, 86, 113);
/* Neutral border color */
@color-border-neutral: rgb(0, 140, 255);
/* Error border color */
@color-border-error: rgb(235, 86, 86);
/* Weakest error border color */
@color-border-error-weakest: rgb(74, 11, 11);
/* Strong error border color */
@color-border-error-strong: rgb(252, 207, 207);
/* Weak error border color */
@color-border-error-weak: rgb(214, 31, 31);
/* Weak neutral border color */
@color-border-neutral-weak: rgb(2, 99, 224);
...
@color-border-success-weak: rgb(20, 176, 83);
/* Strong primary border color */
@color-border-primary-strong: rgb(204, 228, 255);
/* Border on inverse backgrounds. Must be used on color-background-body-inverse. */
@color-border-inverse: rgba(255, 255, 255, 0.5);
/* Destructive focus border color */
@color-border-destructive-strong: rgb(254, 236, 236);
/* Weak primary border color */
@color-border-primary-weak: rgba(255, 255, 255, 0.3);
/* Destructive focus border color */
@color-border-destructive-weak: rgba(255, 255, 255, 0.3);
...
/* Weaker border color */
@color-border-weaker: rgb(57, 71, 98);
/* Border radius reset */
@border-radius-0: 0;
/* Small border radius */
...
@shadow-border-destructive-stronger: 0 0 0 1px #feecec;
/* Stronger shadow border for inputs active. */
@shadow-border-primary-stronger: 0 0 0 1px #ebf4ff;
/* Weaker shadow border for destructive interactions. */
@shadow-border-destructive-weaker: 0 0 0 1px rgba(255, 255, 255, 0.2);
/* Weaker shadow border for primary interactions. */
@shadow-border-primary-weaker: 0 0 0 1px rgba(255, 255, 255, 0.2);
/* Low elevation default shadow. */
@shadow-low: 0 2px 4px 0 rgba(0, 0, 0, 0.2);
...
@shadow-focus: 0 0 0 4px rgba(255, 255, 255, 0.5);
/* Weak shadow border for disabled inputs. */
@shadow-border-weak: 0 0 0 1px #4b5671;
...
@shadow-border-primary: 0 0 0 1px #008cff;
/* Shadow border for destructive interactions. */
@shadow-border-destructive: 0 0 0 1px #eb5656;
/* High elevation default shadow. */
@shadow-high: 0 16px 24px 4px rgba(0, 0, 0, 0.3);
/* Shadow border for error inputs hover. */
@shadow-border-error-strong: 0 0 0 1px #fccfcf;
/* Strongest shadow border for inputs active. */
@shadow-border-primary-strongest: 0 0 0 1px #ffffff;
/* Strongest shadow border for destructive interactions */
@shadow-border-destructive-strongest: 0 0 0 1px #ffffff;
/* Shadow border for inverse error inputs. */
@shadow-border-error-weak: 0 0 0 1px #d61f1f;
/* Shadow border for error inputs. */
@shadow-border-error: 0 0 0 1px #eb5656;
...
@shadow-border-destructive-strong: 0 0 0 1px #feecec;
...
@shadow-border-primary-strong: 0 0 0 1px #cce4ff;
/* Weaker shadow border for primary interactions. */
@shadow-border-primary-weak: 0 0 0 1px rgba(255, 255, 255, 0.3);
/* Weak shadow border for destructive interactions. */
@shadow-border-destructive-weak: 0 0 0 1px rgba(255, 255, 255, 0.3);
/* Weaker shadow border for disabled inputs. */
@shadow-border-weaker: 0 0 0 1px #394762;
...
/* Shadow for cards. */
@shadow-card: 0 2px 4px 0 rgba(0, 0, 0, 0.2);
...
@color-text-link-destructive-weak: rgba(255, 255, 255, 0.2);
...
@color-text-new: rgb(166, 127, 227);
/* Icon color for indicating an error. */
@color-text-icon-error: rgb(245, 138, 138);
...
@color-text-link-weak: rgba(255, 255, 255, 0.2);
/* Body text color */
...
@color-text-weakest: rgb(18, 28, 45);
