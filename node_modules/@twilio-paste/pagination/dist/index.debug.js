...
// src/PaginationItems.tsx
var PaginationItems = React2.forwardRef((_a, ref) => {
  var {children, element = "PAGINATION_ITEMS"} = _a, props = __rest(_a, ["children", "element"]);
  const [validChildren] = React2.useMemo(() => [React2.Children.toArray(children).filter((child) => React2.isValidElement(child))], [children]);
  const keySeed = import_uid_library.useUIDSeed();
  return /* @__PURE__ */ React2.createElement(import_box2.Box, __assign(__assign(__assign({}, ULStyles), import_box2.safelySpreadBoxProps(props)), {
    ref,
    element,
    as: "ul"
  }), validChildren.map((child, index) => {
    return /* @__PURE__ */ React2.createElement(import_box2.Box, __assign(__assign({}, LIStyles), {
...
var import_ArrowBackIcon = __toModule(require("@twilio-paste/icons/cjs/ArrowBackIcon"));

// src/PaginationArrow/PaginationArrowButton.tsx
var React3 = __toModule(require("react"));
var import_box3 = __toModule(require("@twilio-paste/box"));
var PaginationArrowButton = React3.forwardRef((_a, ref) => {
...
var PaginationArrowIconWrapper = ({
  ...
  return /* @__PURE__ */ React4.createElement(import_box4.Box, {
    element,
    alignItems: "center",
...
// src/PaginationArrow/PaginationBackArrow.tsx
var PaginationBackArrow = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(PaginationArrowButton, __assign(__assign({}, props), {
    ref,
    as,
    disabled,
    visibleLabel,
    element: `${element}_BUTTON`
  }), /* @__PURE__ */ React5.createElement(PaginationArrowIconWrapper, {
    isFocused,
    isHovered,
    element: `${element}_ICON_WRAPPER`
  }, /* @__PURE__ */ React5.createElement(import_ArrowBackIcon.ArrowBackIcon, {
    decorative: false,
    display: "block",
    title: label,
    element: `${element}_ICON`
  })), visibleLabel ? /* @__PURE__ */ React5.createElement(import_text.Text, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    marginLeft: "space30",
...
var import_text2 = __toModule(require("@twilio-paste/text"));
var import_ArrowForwardIcon = __toModule(require("@twilio-paste/icons/cjs/ArrowForwardIcon"));
var PaginationForwardArrow = React6.forwardRef((_a, ref) => {
  var {as = "button", element = "PAGINATION_ARROW", disabled, isFocused, isHovered, label, visibleLabel} = _a, props = __rest(_a, ["as", "element", "disabled", "isFocused", "isHovered", "label", "visibleLabel"]);
  return /* @__PURE__ */ React6.createElement(PaginationArrowButton, __assign(__assign({}, props), {
    ref,
    element: `${element}_BUTTON`,
    as,
    disabled,
    visibleLabel
  }), visibleLabel ? /* @__PURE__ */ React6.createElement(import_text2.Text, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    marginRight: "space30",
    element: `${element}_TEXT`
  }, visibleLabel) : null, /* @__PURE__ */ React6.createElement(PaginationArrowIconWrapper, {
    isFocused,
    isHovered,
    element: `${element}_ICON_WRAPPER`
  }, /* @__PURE__ */ React6.createElement(import_ArrowForwardIcon.ArrowForwardIcon, {
    decorative: false,
    display: "block",
    title: label,
    element: `${element}_ICON`
...
// src/PaginationArrow/index.tsx
var PaginationArrow = React7.forwardRef((_a, ref) => {
  var {
    as = "button",
  ...
  return variant === "back" ? /* @__PURE__ */ React7.createElement(PaginationBackArrow, __assign(__assign({}, props), {
    element,
    ref,
    as,
    disabled,
  ...
  })) : /* @__PURE__ */ React7.createElement(PaginationForwardArrow, __assign(__assign({}, props), {
    element,
    ref,
    as,
    disabled,
...
var import_text3 = __toModule(require("@twilio-paste/text"));
var PaginationLabel = React8.forwardRef((_a, ref) => {
  var {children, element = "PAGINATION_LABEL"} = _a, props = __rest(_a, ["children", "element"]);
  return /* @__PURE__ */ React8.createElement(import_text3.Text, __assign(__assign({}, import_text3.safelySpreadTextProps(props)), {
    ref,
    element,
    as: "div",
    color: "colorTextWeak",
...
var import_text4 = __toModule(require("@twilio-paste/text"));
var PaginationEllipsis = React9.forwardRef((_a, ref) => {
  var {label, element = "PAGINATION_ELLIPSIS"} = _a, props = __rest(_a, ["label", "element"]);
  return /* @__PURE__ */ React9.createElement(import_text4.Text, __assign(__assign({}, import_text4.safelySpreadTextProps(props)), {
    ref,
    element,
    "aria-label": label,
    as: "span",
...
var import_text5 = __toModule(require("@twilio-paste/text"));
var PaginationNumber = React10.forwardRef((_a, ref) => {
  ...
  handleLinkValidation({as, href});
  return /* @__PURE__ */ React10.createElement(import_box5.Box, __assign(__assign({}, import_box5.safelySpreadBoxProps(props)), {
    ref,
    element,
    "aria-label": label,
    ...
    _active: {textDecoration: "none"}
  }), children ? /* @__PURE__ */ React10.createElement(import_text5.Text, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    element: `${element}_TEXT`
...
var import_uid_library2 = __toModule(require("@twilio-paste/uid-library"));
var import_box6 = __toModule(require("@twilio-paste/box"));
var PaginationNumbers = React11.forwardRef((_a, ref) => {
  var {children, element = "PAGINATION_NUMBERS", pageLabel} = _a, props = __rest(_a, ["children", "element", "pageLabel"]);
  const [validChildren] = React11.useMemo(() => [React11.Children.toArray(children).filter((child) => React11.isValidElement(child))], [children]);
  const keySeed = import_uid_library2.useUIDSeed();
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, /* @__PURE__ */ React11.createElement(import_box6.Box, __assign(__assign(__assign({}, ULStyles), import_box6.safelySpreadBoxProps(props)), {
    element,
    ref,
    as: "ul",
    justifyContent: "center",
    ...
    return /* @__PURE__ */ React11.createElement(import_box6.Box, __assign(__assign({}, LIStyles), {
