...
import {forwardRef as forwardRef5, useEffect as useEffect7, createElement as createElement11, useRef as useRef6, useCallback as useCallback5} from "react";
...
function useForceUpdate() {
  var _useState = useState(Object.create(null)), dispatch = _useState[1];
...
var Portal = function Portal2(_ref2) {
  var children = _ref2.children, _ref$type = _ref2.type, type = _ref$type === void 0 ? "reach-portal" : _ref$type;
...
function useComposedRefs() {
  ...
  return useCallback2(function(node2) {
...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return /* @__PURE__ */ createElement2(Fragment, null, /* @__PURE__ */ createElement2("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && /* @__PURE__ */ createElement2("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var FocusLock = /* @__PURE__ */ forwardRef(function FocusLockUI(props, parentRef) {
  var _extends22;
  var _React$useState = useState3(), realObserved = _React$useState[0], setObserved = _React$useState[1];
  var observed = useRef3();
  var isActive = useRef3(false);
  var originalFocusedElement = useRef3(null);
  ...
  var _React$useState2 = useState3({}), id = _React$useState2[0];
  var onActivation = useCallback3(function() {
  ...
  var onDeactivation = useCallback3(function() {
    isActive.current = false;
    if (onDeactivationCallback) {
      onDeactivationCallback(observed.current);
    }
  }, [onDeactivationCallback]);
  var returnFocus = useCallback3(function(allowDefer) {
  ...
  var onFocus3 = useCallback3(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = useCallback3(function(newObserved) {
  ...
  return /* @__PURE__ */ createElement3(Fragment2, null, hasLeadingGuards && [
  ...
  ], !disabled && /* @__PURE__ */ createElement3(SideCar2, {
    id,
    ...
    onDeactivation,
    returnFocus
  }), /* @__PURE__ */ createElement3(Container, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), children), hasTailingGuards && /* @__PURE__ */ createElement3("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
  ...
  return function wrap(WrappedComponent) {
    ...
    var SideEffect = /* @__PURE__ */ function(_PureComponent) {
      ...
      _proto.render = function render() {
        return /* @__PURE__ */ React3.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(PureComponent);
...
var isVisibleUncached = function(node2, checkParent) {
  return !node2 || node2 === document || node2 && node2.nodeType === Node.DOCUMENT_NODE || !isElementHidden(window.getComputedStyle(node2, null)) && checkParent(node2.parentNode && node2.parentNode.nodeType === Node.DOCUMENT_FRAGMENT_NODE ? node2.parentNode.host : node2.parentNode);
};
...
// ../../../../node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = /* @__PURE__ */ forwardRef2(function FocusLockUICombination(props, ref) {
  return /* @__PURE__ */ createElement5(Lock_default, _extends({
...
var SideCar = function(_a) {
  ...
  return createElement6(Target, __assign2({}, rest));
};
...
var effectCar = createSidecarMedium2();
...
var RemoveScroll = forwardRef3(function(props, parentRef) {
  ...
  return createElement7(Fragment3, null, enabled && createElement7(SideCar2, {sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref}), forwardProps ? cloneElement(Children.only(children), __assign2({}, containerProps, {ref: containerRef})) : createElement7(Container, __assign2({}, containerProps, {className, ref: containerRef}), children));
});
...
var RemoveScrollBar = function(props) {
  var _a = useState6(getGapWidth(props.gapMode)), gap = _a[0], setGap = _a[1];
  useEffect5(function() {
    setGap(getGapWidth(props.gapMode));
  }, [props.gapMode]);
  var noRelative = props.noRelative, noImportant = props.noImportant, _b = props.gapMode, gapMode = _b === void 0 ? "margin" : _b;
  return createElement8(Style, {styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "")});
};
...
function RemoveScrollSideCar(props) {
  var shouldPreventQueue = useRef5([]);
  var touchStartRef = useRef5([0, 0]);
  var activeAxis = useRef5();
  var id = useState7(idCounter++)[0];
  var Style2 = useState7(function() {
    return styleSingleton();
  })[0];
  var lastProps = useRef5(props);
  useEffect6(function() {
  ...
  var shouldCancelEvent = useCallback4(function(event, parent) {
  ...
  var shouldPrevent = useCallback4(function(_event) {
    var event = _event;
  ...
  var shouldCancel = useCallback4(function(name, delta, target, should) {
  ...
  var scrollTouchStart = useCallback4(function(event) {
    touchStartRef.current = getTouchXY(event);
    activeAxis.current = void 0;
  }, []);
  var scrollWheel = useCallback4(function(event) {
    shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
  }, []);
  var scrollTouchMove = useCallback4(function(event) {
  ...
  return createElement9(Fragment4, null, inert ? createElement9(Style2, {styles: generateStyle(id)}) : null, removeScrollBar ? createElement9(RemoveScrollBar, {gapMode: "margin"}) : null);
}
...
// ../../../../node_modules/react-remove-scroll/dist/es2015/Combination.js
var ReactRemoveScroll = forwardRef4(function(props, ref) {
  return createElement10(RemoveScroll, __assign2({}, props, {ref, sideCar: sidecar_default}));
});
...
var DialogOverlay = /* @__PURE__ */ forwardRef5(function DialogOverlay2(_ref2, forwardedRef) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? "div" : _ref$as, _ref$isOpen = _ref2.isOpen, isOpen = _ref$isOpen === void 0 ? true : _ref$isOpen, props = _objectWithoutPropertiesLoose2(_ref2, ["as", "isOpen"]);
  ...
  return isOpen ? /* @__PURE__ */ createElement11(Portal, {
    "data-reach-dialog-wrapper": ""
  }, /* @__PURE__ */ createElement11(DialogInner, _extends2({
    ref: forwardedRef,
    as: Comp
  }, props))) : null;
});
...
var DialogInner = /* @__PURE__ */ forwardRef5(function DialogInner2(_ref2, forwardedRef) {
  ...
  return /* @__PURE__ */ createElement11(es2015_default2, {
    autoFocus: true,
    returnFocus: true,
    onActivation: activateFocusLock,
    disabled: dangerouslyBypassFocusLock,
    crossFrame: unstable_lockFocusAcrossFrames
  }, /* @__PURE__ */ createElement11(Combination_default2, {
    allowPinchZoom,
    enabled: !dangerouslyBypassScrollLock
  }, /* @__PURE__ */ createElement11(Comp, _extends2({}, props, {
    ref,
...
var DialogContent = /* @__PURE__ */ forwardRef5(function DialogContent2(_ref3, forwardedRef) {
  var _ref3$as = _ref3.as, Comp = _ref3$as === void 0 ? "div" : _ref3$as, onClick = _ref3.onClick;
  _ref3.onKeyDown;
  var props = _objectWithoutPropertiesLoose2(_ref3, ["as", "onClick", "onKeyDown"]);
  return /* @__PURE__ */ createElement11(Comp, _extends2({
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1
  }, props, {
