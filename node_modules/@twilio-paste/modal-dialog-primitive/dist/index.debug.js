...
function useForceUpdate() {
  var _useState = import_react2.useState(Object.create(null)), dispatch = _useState[1];
  return import_react2.useCallback(function() {
...
var Portal = function Portal2(_ref2) {
  ...
  var mountNode = import_react3.useRef(null);
  var portalNode = import_react3.useRef(null);
  ...
  return portalNode.current ? /* @__PURE__ */ import_react_dom.createPortal(children, portalNode.current) : /* @__PURE__ */ import_react3.createElement("span", {
    ref: mountNode
  });
};
if (false) {
...
function useCheckStyles(packageName) {
  if (false) {
    var name = import_react4.useRef(packageName);
    import_react4.useEffect(function() {
...
function useComposedRefs() {
  ...
  return import_react5.useCallback(function(node2) {
...
// ../../../../node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = /* @__PURE__ */ React2.forwardRef(function FocusLockUI(props, parentRef) {
  var _extends22;
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, hasLeadingGuards && [
  ...
  ], !disabled && /* @__PURE__ */ React2.createElement(SideCar2, {
    id,
    ...
    onDeactivation,
    returnFocus
  }), /* @__PURE__ */ React2.createElement(Container, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), children), hasTailingGuards && /* @__PURE__ */ React2.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
  ...
  return function wrap(WrappedComponent) {
    ...
    var SideEffect = /* @__PURE__ */ function(_PureComponent) {
      ...
      _proto.render = function render() {
        return /* @__PURE__ */ import_react7.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
// ../../../../node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = /* @__PURE__ */ React5.forwardRef(function FocusLockUICombination(props, ref) {
  return /* @__PURE__ */ React5.createElement(Lock_default, _extends({
...
function useCallbackRef2(initialValue, callback) {
  var ref = import_react8.useState(function() {
    return {
      value: initialValue,
      callback,
      facade: {
...
var DialogOverlay = /* @__PURE__ */ import_react9.forwardRef(function DialogOverlay2(_ref2, forwardedRef) {
  ...
  import_react9.useEffect(function() {
    if (isOpen) {
  ...
  return isOpen ? /* @__PURE__ */ import_react9.createElement(Portal, {
    "data-reach-dialog-wrapper": ""
  }, /* @__PURE__ */ import_react9.createElement(DialogInner, _extends2({
    ref: forwardedRef,
    as: Comp
  }, props))) : null;
});
...
var DialogInner = /* @__PURE__ */ import_react9.forwardRef(function DialogInner2(_ref2, forwardedRef) {
  ...
  var mouseDownTarget = import_react9.useRef(null);
  var overlayNode = import_react9.useRef(null);
  var ref = useComposedRefs(overlayNode, forwardedRef);
  var activateFocusLock = import_react9.useCallback(function() {
  ...
  return /* @__PURE__ */ import_react9.createElement(es2015_default2, {
    autoFocus: true,
    returnFocus: true,
    onActivation: activateFocusLock,
    disabled: dangerouslyBypassFocusLock,
    crossFrame: unstable_lockFocusAcrossFrames
  }, /* @__PURE__ */ import_react9.createElement(Combination_default2, {
    allowPinchZoom,
    enabled: !dangerouslyBypassScrollLock
  }, /* @__PURE__ */ import_react9.createElement(Comp, _extends2({}, props, {
    ref,
...
var DialogContent = /* @__PURE__ */ import_react9.forwardRef(function DialogContent2(_ref3, forwardedRef) {
  ...
  return /* @__PURE__ */ import_react9.createElement(Comp, _extends2({
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1
  }, props, {
